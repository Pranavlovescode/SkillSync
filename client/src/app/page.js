  ...
  return (
    <div className="min-h-screen w-full flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 p-12 relative">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1557683316-973673baf926')] opacity-20 bg-cover bg-center" />
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <Card className="w-full max-w-md bg-white shadow-xl">
          ...
          <CardFooter className="flex flex-col space-y-4">
            <Button className="w-full h-12 text-lg bg-blue-500 hover:bg-blue-600">
              Sign in
            </Button>
